...
public sealed abstract class BinaryOperationNode extends Node permits AddNode, DivNode, ModNode, MulNode, SubNode, ArithmeticShiftLeftNode, ArithmeticShiftRightNode, LogicalShiftLeftNode, LogicalShiftRightNode, BitwiseAndNode, BitwiseOrNode, XorNode, LogicalAndNode, LogicalOrNode, LessThanNode, LessThanOrEqualNode, EqualNode, NotEqualNode {
