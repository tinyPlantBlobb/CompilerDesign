...
public sealed abstract class Node permits BinaryOperationNode, BitwiseNotNode, Block, ConstBoolNode, ConstIntNode, IfNode, JumpNode, LogicalNotNode, NoDefNode, Phi, ProjNode, ReturnNode, StartNode {
